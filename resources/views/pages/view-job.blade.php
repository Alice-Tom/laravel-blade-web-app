				...
				<div class="single-page-header-inner">
					...
					<div class="right-side">
						<div class="salary-box">
							...
							<div class="salary-amount">{{ $job->min_salary? '$'.$job->min_salary.'k' : '' }} - {{ $job->max_salary? '$'.$job->max_salary.'k' : '' }}</div>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="row" style="padding-top: 6rem!important">
		...
		<div class="col-xl-8 col-lg-8 content-right-offset">
			...
			<div class="single-page-section">
				...
				<div class="listings-container grid-layout">
					...
					<!-- Job Listing -->
					<a href="{{ url('view-job/'.$sim->id) }}" class="job-listing">
						...
						<div class="job-listing-details">
							...
							<div class="job-listing-description">
								...
								<h3 class="job-listing-title">{{ $sim->title }}</h3>
							</div>
						</div>
		...
		<div class="col-xl-4 col-lg-4">
			<div class="sidebar-container">
				...
				<a href="{{ url('apply/'.$job->id) }}" class="apply-now-button popup-with-zoom-anim">Apply Now <i class="icon-material-outline-arrow-right-alt"></i></a>
						...
						<div class="job-overview-inner">
							<ul>
								...
								<li>
									...
									<span>Salary</span>
									<h5>{{ $job->min_salary? '$'.$job->min_salary.'k' : '' }} - {{ $job->max_salary? '$'.$job->max_salary.'k' : '' }}</h5>
								</li>
								<li>
