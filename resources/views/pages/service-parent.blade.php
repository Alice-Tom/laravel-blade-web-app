		...
		<div class="row w-100 m200">
			...
			<div class="col-lg-6">
				<div class="training-img-container">
					<img src="{{ asset($service->cover)}}" class="leftimage" role="img" title="local staff" alt="local staff solutions tag" />
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row m-0">
			...
			<div class="col-lg-6">
				<div class="inner-container-ovr">
					<img src="{{ asset($service->bottom_cover)}}" class="img-side" role="img" title="local staff" alt="local staff solutions tag" />
				</div>
			</div>
		</div>
