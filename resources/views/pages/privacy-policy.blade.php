...
<div class="soltag-header-single" style="background-image: url('img/slide2.jpg');">
	<div class="container-lg-stag inner-title">
		<div class="row m-0 w-100">
			<div class="col-lg-6">
				<h2 class="title"> The Company <span class="circle"></span> Privacy Policy</h2>
			</div>
		</div>
	</div>
</div>
...
<section class="container-lg-stag">
    ...
    <h5>Last updated: May 27, 2021</h5>
...
Agreement) refers to SolutionsTag Consulting Company Limited, Conservation
House, 3rd floor, Morocco, Dar es salaam.</li>
...
<li>Country refers to: Tanzania</li>
...
<li>Usage Data refers to data collected automatically, either generated by the use
of the Service or from the Service infrastructure itself (for example, the
duration of a page visit).</li>

<li>Website refers to SolutionsTag, accessible from  <a href="http://www.solutionstag.co.tz">http://www.solutionstag.co.tz</a> </li>
...
local shared objects?" available at <a href="https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Wher">https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Wher </a> </li>
    <li> <b>Web Beacons.</b>
    <br>
...
pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server
integrity).</li>
...
deleted as soon as You close Your web browser. Learn more about cookies: Cookies:
What Do They Do?.</p>
...
<ul>
    <li>
    With our clients: We may share Your personal information with our clients to
monitor and analyze the you in specific project, to contact You.
    </li>
    <li>
...
to offer You certain job opportunity.
...
generally retained for a short period, except when this data is used to strengthen the
...
computers located outside of Your region, province, country or other governmental
...
<br>
  By email: info@solutionstag.co.tz
<br>
By visiting this page on our website:
<br>
<a href="http://www.solutionstag.co.tz/ourcontacts">http://www.solutionstag.co.tz/ourcontacts</a>


<p>Privacy Policy for SolutionsTag ©2021</p>
