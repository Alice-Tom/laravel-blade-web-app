                        ...
                        <div class="header-widget hide-on-mobile">
                            ...
                            <div class="header-notifications">
                                ...
                                <div class="header-notifications-trigger">
                                    <a href="#"><i
                                            class="icon-feather-bell"></i><span>{{auth::user()->unreadNotifications->count()}}</span></a>
                                </div>
                                ...
                                <div class="header-notifications-trigger">
                                    <a href="#">
                                        <div class="user-avatar status-online"><img
                                                src="{{ asset(auth::user()->avator??'img/members/avator.png') }}"
                                                alt=""></div>
                                    </a>
                                </div>
                                        ...
                                        <div class="user-details">
                                            <div class="user-name">
                                                {{ auth::user()->firstname }} {{ auth::user()->lastname }}<span
                                                    class="text-uppercase">{{ auth::user()->account_type }}</span>
                                            </div>
                                        </div>
