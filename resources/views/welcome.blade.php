...
<section class="mainhero stag-container-main">
	<div class="mainslider">
		<div class="slider-item">
			...
			<img src="{{ asset($home->image1 ?? 'img/slide1.jpg')}}" role="img" title="solutions tag" alt="slide image"/>
			<span class="caption-container">
				<h2 class="hero-title caption-animation-1"> {{$home->title1 ?? 'A BETTER TOMMOROW THROUGH OIL AND GAS'}} </h2>
				<p class="caption-animation-2">{{$name->description1 ?? 'We are integrated oil and gas company specialized in providing technical (engineering, geophysical, consultance) services and trainings.'}}  </p>
				<a href="{{ url('about')}}" class="btn-type-1 magic-hover magic-hover__square light-text caption-animation-3">
					<span>
		...
		<div class="slider-item">
			<span class="overlay-inner"></span>
			<img src="{{ asset($home->image2 ?? 'img/slide2.jpg')}}" role="img" title="solutions tag" alt="slide image"/>
			<span class="caption-container">
		...
		<div class="slider-item">
			<span class="overlay-inner"></span>
			<img src="{{ asset($home->image3 ?? 'img/slide2.jpg')}}" role="img" title="solutions tag" alt="slide image"/>
			<span class="caption-container">
			...
			<div class="innerfullrow">
				...
				<div class="half-video">
					<div class="video-container">
						...
						<a href="{{$home->intro_link ?? '' }}" class="btn-type-1 magic-hover magic-hover__square light-text">
								<span>
	...
	<div class="after-hero">
		<div class="squash">
			<div class="row w-100 m250">
				<div class="col-lg-6">
					<img src="{{ asset($home->sec3_image ?? 'img/staff.png')}}" class="leftimage" role="img" title="local staff" alt="local staff solutions tag" />
				</div>
				<div class="col-lg-6">
	...
	<div class="container-lg-stag">
		<div class="row m-0">
			<div class="col-lg-6 p40">
				...
				<p class="m40">
				Oil and gas industry being one high risk industry,  require specialized technical support for smooth  operations. Yet, cost optimization is the key in  running a profitable business.
				</p>
				<a href="{{ url('services')}}"> <button class="btn btn-st btn-st-primary light"> Read more </button> </a>
			</div>
			<div class="col-lg-6">
				<div class="inner-container-ovr">
					<img src="{{ asset('img/largeImg.jpg')}}" class="img-side" role="img" title="local staff" alt="local staff solutions tag" />
				</div>
			</div>
		</div>
		...
		<div class="row w-100 m200">
			...
			<div class="col-lg-6">
				<div class="training-img-container">
					<img src="{{ asset($home->sec4_image ?? 'img/training.jpg')}}" class="leftimage" role="img" title="local staff" alt="local staff solutions tag" />
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row m-0">
			...
			<div class="col-lg-10">
				<div class="blogs">
					<div class="blog-item">
						<figure>
							<img src="{{ asset('img/slide2.jpg')}}" title="article" alt="blog solutionstag" role="img" />
							<figcaption>
					...
					<div class="blog-item">
						<figure>
							<img src="{{ asset('img/training.jpg')}}" title="article" alt="blog solutionstag" role="img" />
							<figcaption>
								An ilustrated guide to the state of the oil and gas industry in Tanzania
							</figcaption>
							<div class="card-footer-items">
					...
					<div class="blog-item">
						<figure>
							<img src="{{ asset('img/stagvideo.jpg')}}" title="article" alt="blog solutionstag" role="img" />
							<figcaption>
								An ilustrated guide to the state of the oil and gas industry in Tanzania
							</figcaption>
							<div class="card-footer-items">
					...
					<div class="blog-item">
						<figure>
							<img src="{{ asset('img/largeImg.jpg')}}" title="article" alt="blog solutionstag" role="img" />
							<figcaption>
								An ilustrated guide to the state of the oil and gas industry in Tanzania
							</figcaption>
							<div class="card-footer-items">
		...
		<div class="m200">
			<div class="row m-0">
				<div class="@if($featured->isEmpty()) col-lg-12 @else col-lg-6  @endif  br-bb pb-5">
					<h2 class="title_01"> <span class="decor"> {{$home->staff_title ?? 'TECHNICAL STAFFING'}} </span> </h2>
				...
				<div class="col-lg-6">
					<div class="members-seg-container">
						<div class="row m-0">
							...
							<div class="col-lg-6">
								<a href="#" class="float-right"> <h1 class="title_03"> <span class="decor"> VIEW ALL </span>  </h1> </a>
							</div>
						</div>
						<div class="row m-0 pt-3 pb-3">
							@foreach($featured as $f)
							<div class="col-lg-4 experts-items" style="background-image: url('{{ asset($f->avator)}}');" onclick="window.location.href='#'">
			...
			<div class="row">
				<div class="col-lg-6 cta-col-2 pt-5 pb-5">
					<h2 class="title_01"> <span class="light-text"> {{$home->bottom1_title ?? 'LOOKING FOR PROFESSIONALS IN THE OIL & GAS INDUSTRY IN TANZANIA?'}} </span> </h2>
					<p class="p40">
						{{$home->bottom1_link ?? 'It takes just a few steps to create an account and view profiles of local Tanzanian experts to hire.'}}
					</p>
					<a href="{{$home->bottom1_link ?? ''}}" class="btn btn-st btn-st-primary light-btn"> Discover more </a>
				</div>
				<div class="col-lg-6 cta-col-1 pt-5 pb-5">
					<h2 class="title_01"> <span class="light-text"> {{$home->bottom2_title ?? 'ARE YOU AN EXPERT IN THE OIL & GAS INDUSTRY?'}} </span> </h2>
					<p class="p40">
					...
					<a href="{{$home->bottom2_link ?? ''}}" class="btn btn-st btn-st-primary light-btn"> Discover more </a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="client-logos">
				<div>
					<div class="inner-logo-container">
						<img src="{{ asset('img/clients/haentel1.png')}}" class="clientlogos" role="img" alt="solutionstag clients" title="client" />
					</div>
				</div>
				<div>
					<div class="inner-logo-container">
						<img src="{{ asset('img/clients/isuzu_logo.png')}}" class="clientlogos" role="img" alt="solutionstag clients" title="client" />
					</div>
				</div>
				<div>
					<div class="inner-logo-container">
						<img src="{{ asset('img/clients/logo-2.png')}}" class="clientlogos" role="img" alt="solutionstag clients" title="client" />
					</div>
				</div>
				<div>
					<div class="inner-logo-container">
						<img src="{{ asset('img/clients/logo.png')}}" class="clientlogos" role="img" alt="solutionstag clients" title="client" />
					</div>
				</div>
				<div>
					<div class="inner-logo-container">
						<img src="{{ asset('img/clients/logoweb.png')}}" class="clientlogos" role="img" alt="solutionstag clients" title="client" />
					</div>
				</div>
			</div>
		</div>
