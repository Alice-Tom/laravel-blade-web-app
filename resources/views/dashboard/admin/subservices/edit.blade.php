...
<div class="dashboard-container">
	...
	<div class="dashboard-content-container" data-simplebar>
		<div class="dashboard-content-inner">
			...
			<form  method="post"  action="{{ url('subservice/update',$service->id) }}" enctype="multipart/form-data">
				@csrf
				<div class="row m-0">
				...
				<div class="dashboard-box mt-3 mb-3">
					...
					<div class="content with-padding padding-bottom-10">
						<div class="row m-0">
							<label> Title </label>
							<input class="with-border" name="top_title" value="{{ $service->top_title }}">
						</div>

						<div class="row mt-2"> 
							<div class="col-xl-12">
								<label> Segment Content </label>
								<textarea rows="5" name="top_description">{{ $service->top_description }}</textarea>
							</div>
						</div>

						<div class="row mt-2">
							<div class="col-xl-12">
								<label> Segment Image Replace </label>
				...
				<div class="dashboard-box mt-3 mb-3">
					...
					<div class="content with-padding padding-bottom-10">
						...
						<div class="row mt-2"> 
							<div class="col-xl-12">
								<label> Segment Content </label>
								<textarea rows="5" name="bottom_description">{{ $service->bottom_description }}</textarea>
							</div>
						</div>
					...
					<div class="content with-padding padding-bottom-10">
						<div class="row m-0">
							...
							<select class="with-border" name="service_id">
								...
								<option value="{{ $s->id }}" @if($s->id === $service->service_id) selected @endif> {{ $s->title }} </option>
								@endforeach
							</select>
						</div>
					</div>
