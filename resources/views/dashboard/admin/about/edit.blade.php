                ...
                <form method="post" action="{{ url('about/update') }}" enctype="multipart/form-data">
                        ...
                        <div class="content with-padding padding-bottom-10">
                            ...
                            <div class="row mt-2">
                                <div class="col-xl-12">
                                    ...
                                    <textarea rows="5"
                                              name="intro_description">{{$about->intro_description ?? ''}}</textarea>
                                </div>
                            </div>
                    ...
                    <div class="dashboard-box mt-3 mb-3">
                        ...
                        <div class="content with-padding padding-bottom-10">
                            <div class="row m-0">
                                <label> Title </label>
                                <input class="with-border" name="mission1_title"
                                       value="{{$about->mission1_title ?? '' }}">
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-xl-12">
                                    <label> Description </label>
                                    <textarea rows="5"
                                              name="mission1_description"> {{$about->mission1_description ?? '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-xl-12">
                                    ...
                                    <input class="with-border icon-select" placeholder="select icon"
                                           name="mission1_icon" value="{{$about->mission1_icon ?? '' }}">
                                </div>
                            </div>
                        ...
                        <div class="content with-padding padding-bottom-10">
                            <div class="row m-0">
                                <label> Title </label>
                                <input class="with-border" name="mission2_title"
                                       value="{{$about->mission2_title ?? '' }}">
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-xl-12">
                                    <label> Description </label>
                                    <textarea rows="5"
                                              name="mission2_description">{{$about->mission2_description ?? '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-xl-12">
                                    <label> Icon </label>
                                    <input class="with-border" placeholder="select icon" name="mission2_icon"
                                           value="{{$about->mission2_icon ?? '' }}">
                                </div>
                            </div>
                    ...
                    <div class="dashboard-box mt-3 mb-3">
                        ...
                        <div class="content with-padding padding-bottom-10">
                            <div class="row m-0">
                                <label> Title </label>
                                <input class="with-border" name="culture_title"
                                       value="{{$about->culture_title ?? '' }}">
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-xl-12">
                                    ...
                                    <textarea rows="10"
                                              name="culture_description">{{$about->culture_description ?? '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-xl-12">
                                    ...
                                    <textarea rows="5"
                                              name="culture_description_blockquote">{{$about->culture_description_blockquote ?? '' }}</textarea>
                                </div>
                            </div>
                    ...
                    <div class="dashboard-box mt-3 mb-3">
                        ...
                        <div class="content with-padding padding-bottom-10">
                            <div class="row m-0">
                                <label> Title </label>
                                <input class="with-border" name="proposition_title"
                                       name="{{$about->proposition_title ?? ''}}">
                            </div>
                    ...
                    <div class="dashboard-box mt-3 mb-3">
                        <!-- Headline -->
                        <div class="headline">
                            <h3><i class="icon-feather-folder-plus"></i> OUR TEAM </h3>
                        </div>
                        ...
                        <div class="content with-padding padding-bottom-10">
                            <div class="row mt-2">
                                ...
                                <div class="row m-0">
                                    ...
                                    <input class="with-border" name="team_title" value="{{$about->team_title ?? ''}}">
                                </div>
                                <div class="col-xl-12">
                                    <label>Our Team Description </label>
                                    <textarea rows="5"
                                              name="team_description">{{$about->team_description ?? ''}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
