							...
							<div class="row">
								<div class="col-auto">
									<div class="avatar-wrapper" data-tippy-placement="bottom" title="Change Avatar">
										<img class="profile-pic" src="{{ asset(auth::user()->avator??'images/user-avatar-placeholder.png') }}" alt="" />
										...
										<div class="col-xl-6">
											...
											<div class="submit-field">
												...
												<div class="account-type">
													...
													<div>
														<input type="radio" id="employer-radio" class="account-type-radio" disabled/>
						...
						<div class="content with-padding">
							<div class="row">
								...
								<div class="col-xl-6">
									<div class="submit-field">
										<h5>Qualification</h5>
										<select class="selectpicker with-border" data-size="7" name="qualification" title="Select Job Type" data-live-search="true">
								...
								<div class="col-xl-6">
									<div class="submit-field">
										...
										<input type="date" class="form-control" data-toggle="datepicker" name="start_date">
									</div>
								</div>
								...
								<div class="col-xl-6">
									<div class="submit-field">
										<h5>End Date</h5>
										<!--<input type="text" class="with-border">-->
										<input type="date" class="form-control" data-toggle="datepicker" name="end_date">
									</div>
								</div>

							</div>
							<div class="col-xl-12">
								<button class="button ripple-effect big margin-top-30" type="submit"> Add </button>
							</div>
						</div>
					</form>
										...
										<div class="boxed-list-item">
											<div class="item-content">
												...
												<div class="item-details margin-top-7">
													<div class="detail-item"><a href="#"><i class="icon-material-outline-business"></i> {{$edu->institution }}/{{ $edu->country }}</a></div>
													<div class="detail-item"><i class="icon-material-outline-date-range"></i> {{ $edu->start_date }} - {{ $edu->end_date }}</div>
												</div>
											</div>
										</div>
									</li>
							...
							<div class="row">
								...
								<div class="col-xl-6">
									<div class="submit-field">
										...
										<select class="selectpicker with-border" name="level" data-size="7" title="Select Job Type" data-live-search="true">
											<option>Entry </option>
								...
								<div class="col-xl-6">
									<div class="submit-field">
										<h5>End Date</h5>
										<!--<input type="text" class="with-border">-->
										<input type="date" class="form-control" id="exp-end-date" data-toggle="datepicker" name="end_date">
									</div>
								</div>
								...
								<div class="col-xl-12">
									<div class="checkbox">
										<input type="checkbox" id="currently-working" name="currently"  value="currently-working" onclick="working()">
										<label for="currently-working"><span class="checkbox-icon"></span> I am currently working in this position </label>
									</div>
								</div>
									...
									<li>
										<div class="boxed-list-item">
											...
											<div class="item-content">
												<h4>{{ $exp->job_title }}</h4>
												<div class="item-details margin-top-7">
													<div class="detail-item"><a href=""><i class="icon-material-outline-business"></i>{{ $exp->company }}</a></div>
													<div class="detail-item"><i class="icon-material-outline-date-range"></i> {{ $exp->start_date }} - {{ $exp->end_date }}</div>
												</div>
												
												<ul class="boxed-list-ul attached-docs">
													@if($exp->attachment != '')
													<li> <a href="{{ asset($exp->attachment) }}" target="_blank">attachment  </a> </li>
													@endif
												</ul>
